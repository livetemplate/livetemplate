...
> **Scope:** This guide applies to projects generated by the [`lvt` CLI tool](https://github.com/livetemplate/lvt), which lives in a separate repository. The `lvt gen auth` command generates authentication templates; this guide shows how to customize them for different CSS frameworks.

## Overview

The `lvt gen auth` command (from the [lvt CLI](https://github.com/livetemplate/lvt)) generates authentication templates with Tailwind CSS by default. This guide shows you how to customize the generated templates for your preferred CSS framework.
