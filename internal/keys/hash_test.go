...
func TestFormatHashPart_ByteEquivalentToJSON(t *testing.T) {
	cases := []struct {
		...
		{"int16_negative", int16(-300)},
		{"int8_negative", int8(-50)},
		{"uint_positive", uint(42)},
		{"uint64_positive", uint64(1234567890123)},
		{"uint32_positive", uint32(99999)},
		{"uint16_positive", uint16(500)},
		{"uint8_positive", uint8(200)},
		{"bool_true", true},
		{"bool_false", false},
