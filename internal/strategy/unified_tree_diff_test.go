...
func TestUnifiedTreeDiff_CounterExample(t *testing.T) {
	...
	if reconstructed != `<div style="color: #ff6b6b">Hello 0 World</div>` {
	...
	if reconstructed2 != `<div style="color: #45b7d1">Hello 1 World</div>` {
